...
// Mock leave policies với policyId giả lập — TODO: thay bằng API /api/hradmin/leave-policies
const MOCK_LEAVE_POLICIES = [
  { policyId: 1, value: "ANNUAL", label: "Annual Leave" },
  { policyId: 2, value: "MEDICAL", label: "Medical Leave" },
  { policyId: 3, value: "PERSONAL", label: "Personal Leave" },
  { policyId: 4, value: "COMPENSATORY", label: "Compensatory Off" }
];
...
export default function LeaveRequestForm({ formData, onChange, employeeId }) {
  ...
  const selectedPolicy = MOCK_LEAVE_POLICIES.find(t => t.value === formData.leaveType);
  ...
  const handleLeaveTypeChange = (e) => {
    ...
    const policy = MOCK_LEAVE_POLICIES.find(t => t.value === newValue);
